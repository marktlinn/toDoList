...
const TodoForm = ({
  ...
  const handleSubmit = async e => {
    ...
    const response = await fetch("https://todo-be-nblz.onrender.com/api/todo", {
      method: "POST",
  ...
  return (
    <form
      className={
        clicked === true ? "form-active todo-form" : "form-inactive todo-form"
      }
    ...
    >
      ...
      <input
        ...
        placeholder={
          emptyFields.includes("Description") ? "Please fill this field" : ""
        }
